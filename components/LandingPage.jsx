  ...
  return (
    <main>
      <section className="hero-shell">
        ...
        <div className="hero-grid">
          <div className="hero-copy">
            <p className="eyebrow">
              <Sparkles size={16} /> Central property landing page
            </p>
          ...
          <div className="hero-visual">
            <div className="hero-image-card">
              <img
                src={withBasePath(
                  heroPhoto || '/photos/mississauga-placeholder.svg'
                )}
            ...
            <div className="floating-note">
              ...
              <div>
                ...
                <span>
                  Show, hide, link, and refresh property cards locally.
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="control-strip">
        <article>
          <Home size={20} />
          <span>Public-facing portfolio home</span>
        </article>

        <article>
          <Building2 size={20} />
          <span>Connects to dedicated site pages</span>
        </article>

        <article>
          <EyeOff size={20} />
          <span>Exclude any listing with one admin toggle</span>
        </article>
      </section>
      ...
      <section className="properties-section" id="properties">
        <div className="section-heading">
          ...
          <p>
            Each card can be edited in the local admin panel, including cover
            photo, status, summary, and the published property-page link.
          </p>
        </div>
        ...
        {visibleSites.length > 0 ? (
              ...
              return (
                <article className="property-card" key={site.id}>
                  <div className="property-image-wrap">
                    <img
                      src={withBasePath(site.coverImage)}
                  ...
                  <div className="property-body">
                    ...
                    {site.galleryImages?.length > 0 ? (
                      <div
                        ...
                        aria-label={`${site.title} photo gallery`}
                      >
                        {site.galleryImages
                          .slice(0, 10)
                          .map((image, index) => (
                            <figure
                              ...
                              key={`${site.id}-gallery-${index}`}
                            >
                              <img
                                src={withBasePath(image.src)}
                                alt={
                                  image.alt ||
                                  `${site.title} property photo ${index + 1}`
                                }
                                loading="lazy"
                              />
                            </figure>
                    ...
                    {activeUrl ? (
                      <a className="card-button" href={activeUrl}>
                        Open property site <ArrowRight size={17} />
                      </a>
                    ) : (
                      <span className="card-button disabled">
                        Admin: add published site link
                      </span>
                    )}
                  </div>
                </article>
          ...
          <div className="empty-state">
            No property pages are currently visible. Turn one on through the
            admin portal.
          </div>
        )}
      </section>
      ...
      <section className="footer-cta">
        ...
        <a
          ...
          href={`mailto:${portal.contactEmail}`}
        >
          <Mail size={18} /> Email {portal.contactEmail}
        </a>
      </section>
    </main>
  );
